...
public sealed class SiteContentDataSeeder(ApplicationDbContext dbContext)
{
    public async Task SeedAsync()
    {
        ...
        var defaults = new[]
        {
            ...
            new ContentSection{PageKey="Home",SectionKey="demo-featured",Title="Yeni Nesil Sorularda İlk Adım",Subtitle="https://www.youtube.com/",Content="Soruyu doğru okumayı, verileri ayırmayı ve çözüm yolunu planlamayı birlikte öğrenelim.",DisplayOrder=1,IsActive=false},
